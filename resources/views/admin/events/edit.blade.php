            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select name="is_donation_enabled" class="form-select">
                        <option value="0" {{ old('is_donation_enabled', $event->is_donation_enabled ? '1' : '0') == '0' ? 'selected' : '' }}>Tidak</option>
                        <option value="1" {{ old('is_donation_enabled', $event->is_donation_enabled ? '1' : '0') == '1' ? 'selected' : '' }}>Ya</option>
                    </select>
                </div>
                ...
                <div class="col-md-8">
                    ...
                    <div class="input-group">
                        ...
                        <input type="url" name="donation_link" class="form-control @error('donation_link') is-invalid @enderror"
                               value="{{ old('donation_link', $event->donation_link) }}">
                    </div>
